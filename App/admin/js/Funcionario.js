const URL_WEBSERVICE = "http://localhost/AgendaOn-SalaoBeleza/AgendaOn-main/Server/Controllers/FuncionarioController.php"
const enderecoImg = "http://localhost/AgendaOn-SalaoBeleza/AgendaOn-main/Server/img/"
var inputId = document.querySelector('#idfuncionario')
var imgDefault = "http://localhost/AgendaOn-SalaoBeleza/AgendaOn-main/App/admin/img/user.png"
var formSearch
...
function formatDate(dataNascimento)
{
    ...
    dataFormatada = dateNasc.toLocaleDateString('pt-BR', {timeZone: 'UTC'});
            ...
            <div class="box-list">
                ...
                <div id="details-funcionario" class="details-register">
                    ...
                    <div class="field-list">
                        ...
                        <p>${formatDate(funcionario.dtNascimento)}</p>
                    </div>
                    <div class="field-list">
